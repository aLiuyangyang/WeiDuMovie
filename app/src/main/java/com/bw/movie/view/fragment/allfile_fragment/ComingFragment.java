...
public class ComingFragment extends BaseFragment {
    ...
    public void initData(View view) {
        ...
        allComingXrecy.setLayoutManager(linearLayoutManager);
        showAllHotFile_adapter=new ShowAllHotFile_Adapter(getActivity());
        allComingXrecy.setAdapter(showAllHotFile_adapter);
        allComingXrecy.setLoadingListener(new XRecyclerView.LoadingListener() {
            @Override
            public void onRefresh() {
                page=1;
                allComingXrecy.refreshComplete();
                load();
            }
            @Override
            public void onLoadMore() {
                allComingXrecy.loadMoreComplete();
                load();
            }
        });
        load();
