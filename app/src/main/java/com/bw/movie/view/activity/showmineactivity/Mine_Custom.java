...
public class Mine_Custom extends ScrollView {
    ...
    public Mine_Custom(Context context) {
        super(context);
    }

    public Mine_Custom(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public Mine_Custom(Context context, AttributeSet attrs, int defStyleAttr) {
