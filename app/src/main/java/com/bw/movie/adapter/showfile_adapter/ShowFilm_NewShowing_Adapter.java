...
public class ShowFilm_NewShowing_Adapter extends RecyclerView.Adapter<ShowFilm_NewShowing_Adapter.ViewHolder> {
    ...
    public ShowFilm_NewShowing_Adapter(Context context) {
        this.context = context;
        mlist=new ArrayList<>();
    }

    public void setLlist(List<ShowFile_NewShowingBean.ResultBean> list) {
        this.mlist = list;
    ...
    @NonNull
    @Override
    public ShowFilm_NewShowing_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
